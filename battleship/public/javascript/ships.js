function Ship(){
   ...
   this.Carrier = {
    ...
    this.resetAllShips= function(){
        for(var i = 0; i < 10 ; i++){
            for(var j = 0; j < 10; j++){
                board.coordinatsMatrix[i][j] = 0;
                board.deHighLight([i,j]);
            }
        }    
    }
    ...
    this.randomShips=function(){
        ...
        //each time the random button is clicked, the ships will be reset
        for(var i = 0; i < 10 ; i++){
            for(var j = 0; j < 10; j++){
                board.coordinatsMatrix[i][j] = 0;
                board.deHighLight([i,j]);
        ...
        //random coordinate(outter, inner)
        function outter(){
        ...
        //keep trying until have a valid solution
